...
<script src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/17.0.8/js/utils.js"></script>
            ...
            <form id="registrationForm" action="{{route('SuperAdmin.postrecruiter')}}" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="secondname" name="secondname" class="form-control" placeholder="Second Name"  value="{{ old('secondname') }}" pattern="[a-zA-Z'-.\s]{3,50}$" title=" Please Enter 3 to 50 Characters. Only alphabets, apostrophe('), hyphen(-) and period(.) are allowed"  required>
